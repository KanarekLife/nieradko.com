...
Welcome to my new blog. I know that its cliche to write a first post about the process of creating a new blog with a static site generator, but on the other hand it's a good way to test the waters and see if everything is working as expected.

## Why a new blog?

I have been trying to get into writing my own blog for a while now, but there was always something else to do. There were a few iterations of PoC involving different solutions (among other [Hugo](https://gohugo.io/), [SvelteKit](https://svelte.dev/docs/kit/introduction), [Eleventy](https://11ty.dev), [Zola](https://www.getzola.org/) and even rolling out my own custom solution) but none of them really stuck with me. Given that I wanted to build a SSG solution (mostly due to being the easiest to host and maintain) I didn't really go into the route of building a Server Side Rendered solution or a full-fledged CMS.

Having tested a few of SSG generators, one that stuck with me was [Astro](https://astro.build/). Astro is quite a new framework for building static sites.
...
If you have any feedback or suggestions feel free to reach out to me via email or social media. I am always happy to chat with people that share the same interests as me.
